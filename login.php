                            ...
                            <div class="col-lg-6 d-none d-lg-flex bg-login-image align-items-center justify-content-center">
                                <div class="row justify-content-center">
                                    <div class="col-3 d-flex justify-content-center align-items-center p-0">
                                        <img src="assets/img/logo2.png" alt="SMKN9_Bekasi" title="SMKN9_Bekasi" class="logo">
                                    </div>
                            ...
                            <div class="col-lg-6">
                                <div class="p-4 p-sm-5 p-md-5 p-lg-5 p-xl-5">
                                    <div class="text-center">
                                        <img src="assets/img/logo2.png" alt="SMKN9_Bekasi" title="SMKN9_Bekasi" class="logo d-lg-none mb-2">
                                    ...
                                    <form class="user" method="post" action="config/proses_login.php">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user rounded-0" id="exampleInputEmail" aria-describedby="emailHelp" placeholder="Username" name="username" required>
                                        </div>
                                        <div class="form-group">
                                            <input type="password" class="form-control form-control-user rounded-0" id="exampleInputPassword" placeholder="Password" name="password" required>
                                        </div>
                                        <div class="form-group">
